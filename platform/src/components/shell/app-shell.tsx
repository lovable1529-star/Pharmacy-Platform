    ...
    <div className="flex min-h-screen bg-canvas">
      ...
      <aside className="hidden w-[236px] shrink-0 flex-col border-r border-line bg-surface md:flex">
        <div className="flex h-[60px] items-center gap-2.5 border-b border-line px-5">
          <div className="flex h-7 w-7 items-center justify-center rounded-[6px] bg-brand-600 font-display text-[13px] font-bold text-white">
            K
          </div>
        ...
        <div className="border-t border-line p-3">
          <div className="flex items-center gap-2.5 rounded-[7px] px-2 py-1.5">
            <div className="flex h-7 w-7 items-center justify-center rounded-full bg-brand-100 font-mono text-[10.5px] font-medium text-brand-700">
              {initials}
            </div>
